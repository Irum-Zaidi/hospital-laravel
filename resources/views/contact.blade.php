...
<body>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url({{ asset('front_end/assets/img/bg_image_1.jpg') }});">
  ...
  <div class="page-section banner-home bg-image" style="background-image: url({{ asset('front_end/assets/img/banner-pattern.svg') }});">
