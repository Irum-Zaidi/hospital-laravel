            ...
            <div class="row mt-5">
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        ...
                        <div class="body">
                            <h5 class="post-title"><a href="#">List of Countries without Coronavirus case</a>
                            </h5>
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('front_end/assets/img/person/person_1.jpg') }}"
                                            alt="">
                                    </div>
                ...
                <div class="col-lg-4 py-2 wow zoomIn">
                    <div class="card-blog">
                        ...
                        <div class="body">
                            <h5 class="post-title"><a href="#">What is the impact of eating too much sugar?</a>
                            </h5>
                            <div class="site-info">
                                <div class="avatar mr-2">
                                    <div class="avatar-img">
                                        <img src="{{ asset('front_end/assets/img/person/person_2.jpg') }}"
                                            alt="">
                                    </div>
        ...
        <div class="container py-5 py-lg-0">
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 wow fadeInRight">
                    ...
                    <a href="#"><img src="{{ asset('front_end/assets/img/google_play.svg') }}"
                            alt=""></a>
                    <a href="#" class="ml-2"><img src="{{ asset('front_end/assets/img/app_store.svg') }}"
                            alt=""></a>
                </div>
            </div>
        </div>
